...
//Он используется для вычисления фрактала Треуголки.
public class Tricorn extends FractalGenerator
{
    ...
    //Этот метод реализует итерационную функцию для фрактала Треуголки.
    ...
    public int numIterations(double x, double y)
    {
        ...
        //Вычислите Zn = [complex conjugate(Zn-1)]^2 + c 
    ...
    //Реализация toString () Возвращает имя фрактала: «Tricorn».
